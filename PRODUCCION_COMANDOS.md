...
curl -o routes/websocket.py "https://multi-tenant-monitor.preview.emergentagent.com/api/download-file?path=websocket.py"
...
curl -o src/components/noc/DraggableGrid.jsx "https://multi-tenant-monitor.preview.emergentagent.com/api/download-file?path=DraggableGrid.jsx"
curl -o src/components/panels/NOCDashboard.jsx "https://multi-tenant-monitor.preview.emergentagent.com/api/download-file?path=NOCDashboard.jsx"
