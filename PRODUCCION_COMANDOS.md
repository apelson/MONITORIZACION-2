...
curl -o routes/websocket.py "https://group-form-repair.preview.emergentagent.com/api/download-file?path=websocket.py"
...
curl -o src/components/noc/DraggableGrid.jsx "https://group-form-repair.preview.emergentagent.com/api/download-file?path=DraggableGrid.jsx"
curl -o src/components/panels/NOCDashboard.jsx "https://group-form-repair.preview.emergentagent.com/api/download-file?path=NOCDashboard.jsx"
