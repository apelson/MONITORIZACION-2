...
curl -o routes/websocket.py "https://viewport-fix-test.preview.emergentagent.com/api/download-file?path=websocket.py"
...
curl -o src/components/noc/DraggableGrid.jsx "https://viewport-fix-test.preview.emergentagent.com/api/download-file?path=DraggableGrid.jsx"
curl -o src/components/panels/NOCDashboard.jsx "https://viewport-fix-test.preview.emergentagent.com/api/download-file?path=NOCDashboard.jsx"
