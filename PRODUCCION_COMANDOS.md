...
curl -o routes/websocket.py "https://visit-counter-5.preview.emergentagent.com/api/download-file?path=websocket.py"
...
curl -o src/components/noc/DraggableGrid.jsx "https://visit-counter-5.preview.emergentagent.com/api/download-file?path=DraggableGrid.jsx"
curl -o src/components/panels/NOCDashboard.jsx "https://visit-counter-5.preview.emergentagent.com/api/download-file?path=NOCDashboard.jsx"
