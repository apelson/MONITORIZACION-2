...
curl -o routes/websocket.py "https://camera-preview-fix-1.preview.emergentagent.com/api/download-file?path=websocket.py"
...
curl -o src/components/noc/DraggableGrid.jsx "https://camera-preview-fix-1.preview.emergentagent.com/api/download-file?path=DraggableGrid.jsx"
curl -o src/components/panels/NOCDashboard.jsx "https://camera-preview-fix-1.preview.emergentagent.com/api/download-file?path=NOCDashboard.jsx"
