...
curl -o routes/websocket.py "https://alert-central-deploy.preview.emergentagent.com/api/download-file?path=websocket.py"
...
curl -o src/components/noc/DraggableGrid.jsx "https://alert-central-deploy.preview.emergentagent.com/api/download-file?path=DraggableGrid.jsx"
curl -o src/components/panels/NOCDashboard.jsx "https://alert-central-deploy.preview.emergentagent.com/api/download-file?path=NOCDashboard.jsx"
