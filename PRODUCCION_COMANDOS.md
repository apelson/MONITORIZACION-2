...
curl -o routes/websocket.py "https://login-redesign-17.preview.emergentagent.com/api/download-file?path=websocket.py"
...
curl -o src/components/noc/DraggableGrid.jsx "https://login-redesign-17.preview.emergentagent.com/api/download-file?path=DraggableGrid.jsx"
curl -o src/components/panels/NOCDashboard.jsx "https://login-redesign-17.preview.emergentagent.com/api/download-file?path=NOCDashboard.jsx"
