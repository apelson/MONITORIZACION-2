...
curl -o routes/websocket.py "https://brand-center-mgr.preview.emergentagent.com/api/download-file?path=websocket.py"
...
curl -o src/components/noc/DraggableGrid.jsx "https://brand-center-mgr.preview.emergentagent.com/api/download-file?path=DraggableGrid.jsx"
curl -o src/components/panels/NOCDashboard.jsx "https://brand-center-mgr.preview.emergentagent.com/api/download-file?path=NOCDashboard.jsx"
