...
# Cambios: Traducciones NOC, Menú hamburguesa móvil
# ==============================================================================
...
# ==============================================================================
echo "[2/6] Actualizando OrganizationsWidget.jsx..."
...
# ==============================================================================
echo "[3/6] Actualizando HistoryWidget.jsx..."
...
# ==============================================================================
echo "[4/6] Actualizando AlertsWidget.jsx..."
...
# ==============================================================================
# 4. Actualizar traducciones inglés (agregar sección NOC)
# ==============================================================================
echo "[5/6] Actualizando traducciones en inglés..."
# Usar Python para agregar la sección NOC al archivo JSON de inglés
...
# Agregar sección NOC si no existe
if 'noc' not in translations:
    translations['noc'] = {
        "title": "NOC Dashboard",
    ...
    print("Sección NOC agregada a traducciones inglés")
else:
    print("Sección NOC ya existe")
PYTHON_SCRIPT

# ==============================================================================
# 5. Recompilar frontend
# ==============================================================================
echo "[6/6] Recompilando frontend..."
cd frontend
npm run build
...
echo "  - Traducciones de widgets NOC corregidas"
echo "  - Sección NOC agregada a traducciones inglés"
echo ""
