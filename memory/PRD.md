...
curl -o src/components/panels/CRADashboard.jsx "https://noc-dashboard-prod.preview.emergentagent.com/api/download-file?path=CRADashboard.jsx"
curl -o src/components/common/LiveViewerFloatingButton.jsx "https://noc-dashboard-prod.preview.emergentagent.com/api/download-file?path=LiveViewerFloatingButton.jsx"
curl -o src/components/common/SectionLoader.jsx "https://noc-dashboard-prod.preview.emergentagent.com/api/download-file?path=SectionLoader.jsx"
curl -o src/components/panels/AlertsPanel.jsx "https://noc-dashboard-prod.preview.emergentagent.com/api/download-file?path=AlertsPanel.jsx"
curl -o src/components/panels/LiveViewer.jsx "https://noc-dashboard-prod.preview.emergentagent.com/api/download-file?path=LiveViewer.jsx"
curl -o src/App.js "https://noc-dashboard-prod.preview.emergentagent.com/api/download-file?path=App.js"
